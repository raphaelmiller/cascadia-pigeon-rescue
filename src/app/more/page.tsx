...
const ALL_LINKS = [
  ...
  { href: '/transport/calendar', label: 'Transport calendar', icon: Truck, desc: 'Visible month view + pending/unassigned' },
  { href: '/rescue/calendar', label: 'Rescue shift calendar', icon: Siren, desc: 'On-call / active / emergency / open shifts' },
  { href: '/transport', label: 'Driver directory', icon: Truck, desc: 'Transport volunteers (cross-link to fosters)' },
  { href: '/rescue', label: 'Rescuer directory', icon: Siren, desc: 'Rescue volunteers (cross-link to fosters)' },
