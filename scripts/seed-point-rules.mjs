...
const CATALOG = [
  ...
  ['rescue.unable_passed',          'Rescue passed (couldn\'t finish)', 'rescue', 1, 'PR H (2026-05-24): Point Person honestly passed the case back to the pool with a reason. Beats sitting on it.'],
